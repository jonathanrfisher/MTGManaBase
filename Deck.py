class Deck:
        ...
        # 7 different possible mana costs for 7 different
        # possible converted mana costs started with 1 as our
        # zeroth converted mana cost.
        #cards = [[0 for x in range(7)] for x in range(7)]
